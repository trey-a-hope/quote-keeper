...
class QuotesThisMonthCountStateNotifier extends AutoDisposeAsyncNotifier<int> {
  ...
  Future<int> build() async {
    ...
    var rangeStart = DateTime(now.year, now.month, 1, 0, 0, 0);
    var rangeEnd = DateTime(now.year, now.month + 1, 0, 0, 0);
